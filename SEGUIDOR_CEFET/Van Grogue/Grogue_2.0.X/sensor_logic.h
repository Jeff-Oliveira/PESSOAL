...
unsigned char valor_max[6] = {0, 0, 0, 0, 0};
...
unsigned char sensores_frontais_atual[6];
...
void ADC_maq () 
{
    ...
    switch (estado) {
        ...
        case 5:
            estado = 0 ;                        // trocar pro pinout do robo
            sensores_frontais[4] = ADC_ler();   // trocar pro pinout do robo
            ADC_conv_ch(2);                     // trocar pro pinout do robo
            break;            
...
void sentido_de_giro() /*   Branco == 101   Preto = 190 */
{
    ...
    if ((sensores_frontais_atual[0] < 101 && sensores_frontais_atual[5] > 190) || (sensores_frontais_atual[0]  > 190 && sensores_frontais_atual[5] < 101))    
    ...
    else if ((sensores_frontais_atual[1] < 101 || sensores_frontais_atual[4] < 101))  
    {
...
{    
    ...
    if ((sensores_frontais_atual[1] > 190) && (sensores_frontais_atual[2] > 190)) //saindo da pista, curva à esquerda
    {
        giro_esquerda();
    ...
    else if((sensores_frontais_atual[3] > 190) && sensores_frontais_atual[4] > 190) //saindo da pista, curva à direita
    {
        giro_direita();
     ...
     * Obs.: Os valores mudam de acordo com o 
     * N° de sens. e suas posições
